//
//  ImplementationDiffingCollectionViewController.swift
//  MVVMAnimation
//
...
class ImplementationDiffingCollectionViewController: UICollectionViewController {
...
extension ImplementationDiffingCollectionViewController {
...
extension ImplementationDiffingCollectionViewController: UICollectionViewDelegateFlowLayout {
...
extension ImplementationDiffingCollectionViewController: DiffingInteractorDelegate {

    func didUpdateViewModel(_ viewModel: AlbumViewModel) {
        DispatchQueue.main.async {
            self.collectionView.visibleCells.forEach {
                if let albumCell = $0 as? AlbumCell,
                    let albumCellViewModel = albumCell.viewModel {
                    if albumCellViewModel.id == viewModel.id {
